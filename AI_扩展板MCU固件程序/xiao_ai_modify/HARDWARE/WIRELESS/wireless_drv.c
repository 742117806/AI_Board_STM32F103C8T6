...
/*{ 0X11，组名，参数个数Number，从Number开始配置,具体的参数配置 }*/
/*********************************** si4438 的参数设置 ************************************/
//晶振调整
...
//中断配置
//unsigned char const RF_INT_CTL_ENABLE_2[] = {0x11, 0x01, 0x03, 0x00, 0x03, 0x3B, 0X09};
unsigned char const RF_INT_CTL_ENABLE_2[] = {0x11, 0x01, 0x03, 0x00, 0x03, 0x3B, 0X01};
//快速寄存器配置
unsigned char const RF_FRR_CTL_A_MODE_4[] = {0x11, 0x02, 0x04, 0x00, 0x03, 0x05, 0x00, 0x0a};
...
//包的整体配置
unsigned char const RF_PKT_CONFIG1_1[] = {0x11, 0x12, 0x01, 0x06, 0x01}; //81域分开01不分开
...
//基准频率和步进配置
//unsigned char const RF_FREQ_CONTROL_INTE_8[] = {0x11, 0x40, 0x08, 0x00, 0x3D, 0x0E, 0xEE, 0xEE, 0x36, 0x9D, 0x20, 0xFE};//470MHz

unsigned char const RF_FREQ_CONTROL_INTE_8[] = {0x11, 0x40, 0x08, 0x00, 0x40, 0x0A, 0xAA, 0xAA, 0x36, 0x9D, 0x20, 0xFE}; //490MHz

//PA设置
unsigned char const RF_PA_TC_1[] = {0x11, 0x22, 0x04, 0x00, 0x08, 0x7F, 0x00, 0x1D};
...
/*******************************************************************************************************/
#ifdef Use_Rx_Hop
//跳频配置(频道不要太多，否则会影响接收)      物理频道和通信频道要匹配,加入了RSSI超时跳频
...
uint8_t pk_set3[] = {0x11, 0x12, 0x04, 0x11, 0x00, 0xFA, 0x02, 0x22};
//1221-1234 RX
uint8_t pk_set4[] = {0x11, 0x12, 0x04, 0x21, 0x00, 0x01, 0x06, 0x82};
//uint8_t pk_set5[] = {0x11, 0x12, 0x04, 0x25, 0x01, 0x00, 0x02, 0x0a};
uint8_t pk_set5[] = {0x11, 0x12, 0x04, 0x25, 0x00, 0xFA, 0x02, 0x02};
...
unsigned char const rssi_threshold[] = {0x11, 0x20, 0x01, 0x4a, 0xff}; //Config RSSI Threshold --> 255
unsigned char const pkt_crc_config[] = {0x11, 0x12, 0x01, 0x00, 0x04}; //PKT_CRC_CONFIG

//中断设置
unsigned char const Receive_Interrupt_set[] = {0x11, 0x01, 0x03, 0x00, 0x03, 0x19, 0x09}; //加入RSSI接收阈值
...
unsigned char RF_GPIO_PIN_CFG[] = {0x13, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
