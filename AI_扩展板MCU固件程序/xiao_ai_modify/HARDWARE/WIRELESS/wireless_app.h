...
typedef struct
{
  ...
  uint8_t Wireless_RxData[WIRELESS_BUFF_LEN];
  //uint8_t Wireless_TxHeader[4];
  uint8_t Wireless_TxData[WIRELESS_BUFF_LEN];
  uint8_t Wireless_RealData[WIRELESS_BUFF_LEN];
