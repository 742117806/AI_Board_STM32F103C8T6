...
//SN3218管脚相关配置定义
#define LED_SN3218A_SDB_Pin 		GPIO_Pin_7   //开关机管脚
#define LED_SN3218A_SDB_GPIO_Port 	GPIOB
#define LED_SN3218A_SDA_Pin 		GPIO_Pin_8   //数据管脚
#define LED_SN3218A_SDA_GPIO_Port 	GPIOB
#define LED_SN3218A_SCL_Pin 		GPIO_Pin_9   //时钟管脚
...
#define SN3218_ADDR 0xa8	//器件地址

//寄存器地址对应功能

#define	SN3218_OFF_REG		0x00	//关断寄存器，关闭所有通道
#define	SN3218_PWM1_REG		0x01	//LED1 PWM寄存器地址
...
#define	SN3218_PWM17_REG	0x11 //LED17 PWM寄存器地址
#define SN3218_PWM18_REG	0x12 //LED18 PWM寄存器地址
#define	SN3218_LED_CTRL1_REG	0x13
#define	SN3218_LED_CTRL2_REG	0x14
#define	SN3218_LED_CTRL3_REG	0x15
#define	SN3218_REF_REG			0x16         //刷新寄存器
#define	SN3218_REST_REG 		0x17		//重置所有寄存器为默认值
