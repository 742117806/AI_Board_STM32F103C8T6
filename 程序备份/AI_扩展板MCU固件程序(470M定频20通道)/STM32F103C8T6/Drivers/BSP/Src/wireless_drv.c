...
Wireless_ErrorType SI4438_PWUP_Init(void)
{
  ...
  tocnt = 0x0020;
  if(Si4438Cmd_Reply.PART_INFO.PART != 0x4438) return Wireless_InitError;
  else return Wireless_NoError;
}
...
//全局配置
unsigned char const RF_GLOBAL_CONFIG_1[] = {0x11, 0x00, 0x01, 0x03, 0x20};	
...
//报头设置                                                                               前导有效时间  信道停留时间
unsigned char const RF_PREAMBLE_TX_LENGTH_1[] = {0x11, 0x10, 0x05, 0x00, PREAMBLE_LENGTH, 0x14, 0x00, 0x08, 0x12};			
//unsigned char const RF_PREAMBLE_TX_LENGTH_1[] = {0x11, 0x10, 0x05, 0x00, PREAMBLE_LENGTH, 0x0A, 0x00, 0x14, 0x12};  //前导判断有效为 10bit， 信道停留时间为 20bit
//同步字段设置
unsigned char const RF_SYNC_CONFIG_3[] = {0x11, 0x11, 0x03, 0x00, 0x01, SYNC_31_24, SYNC_23_16};		

//包的整体配置
//unsigned char const RF_PKT_CONFIG1_1[] = {0x11, 0x12, 0x01, 0x06, 0x01};		
...
//RSSI配置
//unsigned char const RF_MODEM_RSSI_CONTROL_3[] = {0x11, 0x20, 0x03, 0x4C, 0x11, 0x00, 0x3a};
unsigned char const RF_MODEM_RSSI_CONTROL_3[] = {0x11, 0x20, 0x03, 0x4C, 0x11, 0x00, 0x3a};
//基准频率和步进配置
...
unsigned char const pkt_crc_config[] = {0x11,0x12,0x01,0x00,0x85};						//PKT_CRC_CONFIG
